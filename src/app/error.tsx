...
export default function Error({
  ...
  useEffect(() => {
    // Structured error logging (omitting sensitive keys)
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 sm:p-12 text-center space-y-5 shadow-lg">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
              We encountered an unexpected issue while retrieving academic records. Please try reloading the page.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Button
              ...
              variant="primary"
              size="md"
              className="w-full sm:w-auto font-bold gap-2 bg-blue-600 hover:bg-blue-700"
            >
